...
interface CodeSliceDefaultPrimary {
    /**
     * Title field in *Code → Primary*
     *
     * - **Field Type**: Title
     * - **Placeholder**: This is where it all begins...
     * - **API ID Path**: code.primary.title
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    title: prismicT.TitleField;
    /**
     * Description field in *Code → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: code.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
 ...
 *
 */
export interface CodeSliceDefaultItem {
    /**
     * code field in *Code → Items*
     *
     * - **Field Type**: Embed
     * - **Placeholder**: *None*
     * - **API ID Path**: code.items[].code
 ...
 *
 */
export type CodeSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<CodeSliceDefaultPrimary>, Simplify<CodeSliceDefaultItem>>;
/**
